...
public enum EventType {
    ...
    UNKNOWN_49,
    /**
     * Table metadata event (Twitter patch)
     * https://github.com/twitter/mysql/wiki/Binary-Log-Options-and-Variables#binlog_rows_table_metadata_events
     * https://github.com/twitter/mysql/blob/865aae5f23e2091e1316ca0e6c6651d57f786c76/sql/log_event.h#L605
     */
    TABLE_METADATA; // 50
    ...
    public static boolean isUnknown(EventType eventType) {
